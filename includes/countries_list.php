<?php
/**
 * Compact world countries dataset used by the premium bank transfer form.
 * Fields: iso2 (uppercase), name, dial (calling code without +).
 * Kept intentionally static so the same list can be serialized to JS.
 *
 * @return array<int, array{iso2:string,name:string,dial:string}>
 */
function iN_GetCountriesList(): array {
