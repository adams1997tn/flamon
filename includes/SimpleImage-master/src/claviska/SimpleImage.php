...
class SimpleImage {
  ...
  public function fromFile($file) {
    ...
    case 'image/jpeg':
      ...
      break;
    case 'image/png':
      // Suppress libpng profile warnings (eg malformed iCCP in transparent PNG uploads) so processing can continue.
  ...
  protected static function imageCopyMergeAlpha($dstIm, $srcIm, $dstX, $dstY, $srcX, $srcY, $srcW, $srcH, $pct) {
    ...
    if($pct < 100) {
      ...
      $alpha = (int) round(127 * ((100 - $pct) / 100));
      $alpha = max(0, min(127, $alpha));
      imagefilter($srcIm, IMG_FILTER_COLORIZE, 0, 0, 0, $alpha);
    }
