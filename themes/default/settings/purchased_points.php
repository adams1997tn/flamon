           ...
           <div class="i_tab_list_item_container">
            ...
            ?>
                ...
                <div class="i_tab_list_item flex_">
                    ...
                    <div class="tab_detail_item item_mobile"><?php echo iN_HelpSecure(formatCurrency($planAmount, $currencyCode));?></div>
                    ...
                    <div class="tab_detail_item item_mobile">
                        <?php if ($invoiceToken) { ?>
                            <a class="table_invoice_link" target="_blank" href="<?php echo iN_HelpSecure($base_url).'invoice?token='.iN_HelpSecure($invoiceToken);?>">
                                <?php echo iN_HelpSecure($invoiceNumber ?: $LANG['invoice_number']);?>
                            </a>
                        <?php } else { echo '-'; } ?>
                    </div>
               </div>
