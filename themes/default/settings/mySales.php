           ...
           <div class="i_tab_list_item_container">
            <?php
               ...
               if($ownProducts){
                  foreach($ownProducts as $prData){
                      ...
                      $productAgencyEarning = $prData['agency_earning'] ?? null;
            ...
            ?>
                ...
                <div class="i_tab_list_item flex_">
                    ...
                    <div class="tab_detail_item item_mobile"><?php echo iN_HelpSecure(formatCurrency($productSalesAmount, $defaultCurrency));?></div>
                    <div class="tab_detail_item item_mobile" id="pr_s_<?php echo iN_HelpSecure($productID);?>">
                        <?php echo iN_HelpSecure(formatCurrency($productAdminEarning, $defaultCurrency));?>
                    </div>
                    <div class="tab_detail_item item_mobile" id="pr_s_<?php echo iN_HelpSecure($productID);?>">
                        <?php echo iN_HelpSecure(formatCurrency((float)$productAgencyEarning, $defaultCurrency));?>
                    </div>
                    <div class="tab_detail_item item_mobile" id="pr_s_<?php echo iN_HelpSecure($productID);?>">
                        <?php echo iN_HelpSecure(formatCurrency($productUserEarning, $defaultCurrency));?>
                    </div>
               </div>
               <!--/ITEM-->
            <?php }
