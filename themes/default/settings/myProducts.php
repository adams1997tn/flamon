                    ...
                    ?>
                        ...
                        foreach ($explodeFiles as $explodeProductFile) {
                            ...
                            if ($productFileData) {
                                ...
                                $preferredPath = !empty($productTumbnailfilePath) ? $productTumbnailfilePath : $productfilePath;
                                $absPreferred = realpath(__DIR__ . '/../../..') . '/' . ltrim($preferredPath, '/');
                                if (!is_file($absPreferred) && !empty($productfilePath)) {
                                    $preferredPath = $productfilePath;
                                }
                                if (function_exists('storage_public_url')) {
                                    $productImageUrl = storage_public_url($preferredPath);
                                } else {
                                    $productImageUrl = $base_url . $preferredPath;
                                }
?>
...
<?php } } ?>
                            ...
                            <div class="tab_detail_item item_mobile"><?php echo iN_HelpSecure(formatCurrency($productPrice, $defaultCurrency));?></div>
