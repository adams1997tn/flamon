                ...
                if($storiePostData){
                   foreach($storiePostData as $stData){
                       ...
                       if($storieFileExt != 'mp4'){
                        ...
                        $storyReactionCount = $iN->iN_GetStoryReactionCount($storieID);
                ?>
                    <!---->
                            ...
                            <div class="st_det transitions">
                                <div class="set_items">
                                    ...
                                    <div class="set_ite_footer flex_ tabing">
                                        ...
                                        <div class="set_replies flex_ tabing">
                                             <?php echo html_entity_decode($iN->iN_SelectedMenuIcon('38')).$storyReplyCount; ?>
                                        </div>
                                        <div class="set_reactions flex_ tabing">
                                             <?php echo html_entity_decode($iN->iN_SelectedMenuIcon('18')).$storyReactionCount; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
