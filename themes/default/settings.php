...
if (($pageGet ?? '') === 'account_delete' && !$accountDeletionAutomationEnabled) {
    header('Location: ' . route_url('settings'));
    exit;
}
if (($pageGet ?? '') === 'obs_overlays' && !$iN->iN_IsObsOverlayEnabled()) {
    header('Location: ' . route_url('settings'));
    exit;
}
?>
                ...
                if ($pageGet) {
                    switch ($pageGet) {
                        ...
                        case 'dashboard':
                            ...
                            break;
                        case 'bulk_messages':
                            include("settings/creator_bulk_messages.php");
                            break;
                        case 'creator_auto_message':
                            include("settings/creator_auto_message.php");
                            break;
                        case 'agencies':
                            include("settings/agencies.php");
                            break;
                        case 'obs_overlays':
                            include("settings/obs_overlays.php");
                            break;
                        ...
                        case 'account_delete':
                            include("settings/account_delete.php");
                            break;
