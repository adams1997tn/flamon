       ...
       <div class="landng_section_four_in">
          ...
          <div class="landing_features_list"> 
              <div class="creators_list_container">
                <?php
                $featuredCreators = $iN->iN_PopularUsersFromLastWeekInExplorePageLanding(3, $userID ?? null, $viewerCountryCode ?? null);
                $featuredCreatorIds = [];
                if ($featuredCreators) {
                ...
                foreach($featuredCreators as $td){
                    ...
                    $uD = isset($featuredProfileMap[$popularUserIntID]) ? $featuredProfileMap[$popularUserIntID] : [];
           ...
           <div class="ranges flex_ tabing">
            ...
            <div class="landing_create_equal_box">
                <div class="smiulator_helper tabing_non_justify flex_">
                    ...
                    <div class="helper_right flex_ tabing"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('51'));?><span id="monthlySubscription"><?php echo iN_HelpSecure(formatCurrency(2, $defaultCurrency));?></span></div>
                </div>
            </div>
            </div>
