<div class="stories_outer">
    <button type="button" class="stories_nav stories_nav-prev is-hidden" data-dir="prev" aria-label="Previous stories">&lsaquo;</button>

    <div class="stories_wrapper flex_">
        <div class="stories_scroller flex_">
            <div class="story-view-item-fake chsStoryw" data-background-image="<?php echo iN_HelpSecure($userAvatar); ?>" style="--story-bg:url('<?php echo iN_HelpSecure($userAvatar); ?>');">
                ...
                <span class="name truncate"><?php echo iN_HelpSecure($LANG['your_story']); ?></span>
            </div>
            ...
            ?>
            <div class="story-view-item-fake story-live" data-background-image="<?php echo iN_HelpSecure($liveUserAvatar); ?>" style="--story-bg:url('<?php echo iN_HelpSecure($liveUserAvatar); ?>');">
                <a class="story-link" href="<?php echo iN_HelpSecure($base_url) . 'live/' . iN_HelpSecure($liveCreatorUserName); ?>">
                    <div class="story-bubble">
                        <div class="story-ring">
                            <div class="story-view-pr-avatar" data-avatar="<?php echo iN_HelpSecure($liveUserAvatar); ?>"></div>
                        </div>
                        <div class="story-live-badge flex_">
                            <div class="story-live-icon"><?php echo html_entity_decode($lStat); ?></div>
                            <span><?php echo iN_HelpSecure($LANG['live_now']); ?></span>
                        </div>
                    </div>
                    <span class="name truncate"><?php echo iN_HelpSecure($liveCreatorUserName); ?></span>
                </a>
            </div>
            <?php }} ?>
    ...
    <button type="button" class="stories_nav stories_nav-next" data-dir="next" aria-label="Next stories">&rsaquo;</button>
</div>
