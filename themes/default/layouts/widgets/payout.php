...
<div class="certification_form_container">
  ...
  <div class="certification_form_not"><?php echo iN_HelpSecure($payoutMethodsText);?></div>
      ...
      <div class="i_set_subscription_fee_box">
        ...
        <div class="payout_method_fields" data-method="<?php echo iN_HelpSecure($methodKey);?>" style="<?php echo $selectedPayoutMethod === $methodKey ? '' : 'display:none;'; ?>">
          ...
          <div class="i_set_subscription_fee margin-bottom-ten">
            ...
            <div class="i_payout_">
              <input type="text" class="transition aval" id="paypale" placeholder="<?php echo iN_HelpSecure($LANG['paypal_email']);?>" value="<?php echo iN_HelpSecure($safePaypalEmail);?>">
            </div>
          </div>
          <div class="i_set_subscription_fee margin-bottom-ten">
            <div class="i_subs_currency"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('80'));?></div>
            <div class="i_payout_">
              <input type="text" class="transition aval" id="paypalere" placeholder="<?php echo iN_HelpSecure($LANG['confirm_paypal_email']);?>" value="<?php echo iN_HelpSecure($safePaypalEmail);?>">
            </div>
          </div>
          <?php } elseif ($methodKey === 'bank') {?>
          <?php include __DIR__ . '/bank_transfer_form.php'; ?>
