<div class="mobile_footer_fixed_menu_container">
    <div class="mobile_fixed_box_wrapper flex_ tabing">
        ...
        <!---->
        <!---->
        <div class="mobile_box g_feed" data-get="allPosts" data-type="moreexplore">
            <div class="i_m_box_item transition flex_ tabing"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('8'));?></div>
        </div>
        <!---->
        <!---->
        <?php if (isset($reelsFeatureStatus) && (string)$reelsFeatureStatus === '1') { ?>
        <div class="mobile_box">
            <a href="<?php echo filter_var($base_url, FILTER_VALIDATE_URL);?>reels/"><div class="i_m_box_item transition flex_ tabing"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('187'));?></div></a>
        </div>
        <?php } ?>
        <!---->
        <!---->
