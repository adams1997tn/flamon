    ...
    <div class="i_modal_in_in modal_tip">
        <div class="i_modal_content">
            ...
            <div class="i_more_text_wrapper">
                <div class="i_set_subscription_fee_box">
                    <div class="i_set_subscription_fee"
                         ...
                         data-one-point-equal="<?php echo iN_HelpSecure($onePointEqual); ?>"
                         data-currency="<?php echo iN_HelpSecure($currencys[$defaultCurrency]); ?>">
                    ...
                    <div class="i_tip_not" data-base-note="<?php echo iN_HelpSecure($LANG['min_tip_amount']); ?>">
            ...
            <div class="i_block_box_footer_container">
                ...
                <div class="send_tip_methods_btn"
                     role="button"
