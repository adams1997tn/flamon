<div class="live_stream_list flex_">
    ...
    <div class="live_item_cont scheduledLive">
        <a href="<?php echo iN_HelpSecure($base_url . 'live_streams?live=scheduled'); ?>" title="<?php echo iN_HelpSecure($LANG['live_scheduled_list_title']); ?>">
            <div class="live_item transition">
                <div class="live_title flex_">
