  ...
  <div class="i_user_details">
      ...
      <div class="i_header_others_box">
           ...
           <a href="<?php echo iN_HelpSecure($base_url);?>settings?tab=payments">
            <div class="i_header_others_item transition">
               <div class="i_header_item_icon_box"><?php echo html_entity_decode($iN->iN_SelectedMenuIcon('77'));?></div> <?php echo iN_HelpSecure($LANG['y_earnings_balance']);?><?php echo iN_HelpSecure(formatCurrency($userWallet, $defaultCurrency));?>
            </div>
           </a>
           <div class="arrow"></div>
           <?php if($feesStatus == '2'){?>
