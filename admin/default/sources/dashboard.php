    ...
    <div class="i_contents_section flex_ tabing">
       ...
       <div class="row_wrapper">
           <div class="row_item flex_ column border_one c3">
              ...
              <div class="chart_row_box_sum"><span class="count-num"><?php echo iN_HelpSecure($iN->formatCompactNumber((int)$iN->iN_TotalUsers()));?></span></div>
       ...
       <div class="row_wrapper">
           <div class="row_item flex_ column border_one c4">
              ...
              <div class="chart_row_box_sum"><span class="count-num"><?php echo iN_HelpSecure($iN->formatCompactNumber((int)$iN->iN_TotalUserPosts()));?></span></div>
...
$rowsSubs = DB::all("SELECT DAY(created) - 1 AS dayIndex, SUM(admin_earning) AS daily_total FROM i_user_subscriptions WHERE MONTH(created) = MONTH(CURDATE()) AND YEAR(created) = YEAR(CURDATE()) AND status IN('active','inactive') AND in_status IN('1','0') AND finished = '0' AND subscription_scope = 'profile' GROUP BY DAY(created) ORDER BY DAY(created)");
