    ...
    <div class="i_general_white_board border_one column flex_ tabing__justify">
        ...
        <div class="i_general_row_box column flex_ white_board_padding_" id="general_conf">
            ...
            <div class="i_general_row_box_item flex_ tabing__justify">
                ...
                <div class="irow_box_right">
                    <div class="i_checkbox_wrapper flex_ tabing_non_justify">
                        <label class="el-switch el-switch-yellow" for="mercadopago_beta">
                            <input type="checkbox" class="chmdPayment" id="mercadopago_beta" data-active-value="1" data-inactive-value="0" <?php echo (isset($mercadoPagoPaymentBeta) && $mercadoPagoPaymentBeta == '1') ? 'value="0" checked="checked"' : 'value="1"'; ?>>
                            <span class="el-switch-style"></span>
                        </label>
                        <div class="success_tick tabing flex_ sec_one mercadopago_beta">
                            <?php echo html_entity_decode($iN->iN_SelectedMenuIcon('69')); ?>
                        </div>
                    </div>
