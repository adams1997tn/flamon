<div class="i_contents_container general_top profile-categories-page">
    <div class="i_general_white_board border_one column flex_ tabing__justify">
        ...
        <div class="i_general_row_box column flex_" id="business_conf">
            <div class="new_svg_icon_wrapper profile-categories-toolbar flex_ tabing_non_justify">
                <?php
                ...
                <div class="profile-categories-summary">
                    <?php echo iN_HelpSecure($LANG['profile_categories_and_subcategories']) . ': ' . iN_HelpSecure((string)$totalCategories); ?>
                </div>
            </div>
            ...
            if ($categories) {
                foreach ($categories as $caData) {
                    ...
                    $subCategoryCount = is_array($checkAndGetSubCat) ? count($checkAndGetSubCat) : 0;
            ?>
            <div class="profile-category-shell">
                <div class="i_general_row_box_item flex_ tabing_non_justify typing_textarea_story" id="gen_<?php echo iN_HelpSecure($categoryID); ?>">
                    <div class="irow_box_left profile-category-title">
                        ...
                        <span class="profile-category-sub-count"><?php echo iN_HelpSecure((string)$subCategoryCount); ?></span>
                    </div>
                    <div class="irow_box_right">
                        ...
                        <div class="flex_ tabing cat_se cse_<?php echo iN_HelpSecure($categoryID); ?>">
                            <input type="text" class="i_input_cce flex_ keyFormatInput" id="cat_va_<?php echo iN_HelpSecure($categoryID); ?>" value="<?php echo iN_HelpSecure($categoryKey); ?>" placeholder="<?php echo iN_HelpSecure($LANG['new_cat_key_h']); ?>" maxlength="190" autocomplete="off" spellcheck="false">
                        </div>
                    </div>
                    <div class="seePost border_one transition tabing flex_ toggleSubCategories" data-id="<?php echo iN_HelpSecure($categoryID); ?>" aria-expanded="true">
                        <span class="toggleSubCategoriesIcon">-</span>
                    </div>
                ...
                <div class="i_general_row_item flex_ tabing_non_justify profile-sub-wrap" id="sub_wrap_<?php echo iN_HelpSecure($categoryID); ?>">
                    <div class="irow_box_left">
                        <?php echo iN_HelpSecure($LANG['sub_categories_for']) . ' ' . (isset($PROFILE_CATEGORIES[$categoryKey]) ? $PROFILE_CATEGORIES[$categoryKey] : preg_replace('/{.*?}/', $categoryKey, $LANG['add_this_not_for_key'])); ?>
                    </div>
                    <div class="irow_box_right subCat border_one">
                        ...
                        <div class="cat_sub_item flex_" id="general_conf<?php echo iN_HelpSecure($scID); ?>">
                            ...
                            <div class="flex_ tabing sub_se se_<?php echo iN_HelpSecure($scID); ?>">
                                <input type="text" class="i_input_sce flex_ keyFormatInput" id="sub_va_<?php echo iN_HelpSecure($scID); ?>" value="<?php echo iN_HelpSecure($subCategoryKey); ?>" maxlength="190" autocomplete="off" spellcheck="false">
                            </div>
                        ...
                        <div class="cat_sub_item flex_ tabing_non_justify border_one n_s_c_<?php echo iN_HelpSecure($categoryKey); ?> nonePoint" id="<?php echo iN_HelpSecure($categoryKey); ?>">
                            <div class="flex_ sub_se_new margin_bottom_custom_css_js">
                                <input type="text" name="newsubcat" class="i_input_sce flex keyFormatInput" id="n_<?php echo iN_HelpSecure($categoryKey); ?>" placeholder="<?php echo iN_HelpSecure($LANG['new_subcat_key_h']); ?>" maxlength="190" autocomplete="off" spellcheck="false">
                            </div>
