...
?>
<div class="i_contents_container manage-users-page">
                ...
                <div class="i_overflow_x_auto">
                    <table class="border_one">
                        ...
                        <?php foreach ($allUsers as $uData):
                            ...
                            } elseif ($userUserType === '3') {
                                $utyp = '<div class="ut tabing flex_ forpending bluebg">' . $iN->iN_SelectedMenuIcon('115') . $LANG['moderator'] . '</div>';
                            }
                        ...
                        ?>
                            <tr class="transition trhover">
                                ...
                                <td class="flex_ tabing">
                                    <div class="flex_ tabing_non_justify">
                                        <?php if ($canDeleteUsers && $userUserType !== '2'): ?>
