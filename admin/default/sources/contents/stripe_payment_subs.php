                ...
                <div class="irow_box_right">
                    <div class="i_checkbox_wrapper flex_ tabing_non_justify">
                        <label class="el-switch el-switch-yellow" for="stripe_sub_status">
                            <input type="checkbox" name="stripe_sub_status" class="chmdSubPayment" id="stripe_sub_status" data-active-value="2" data-inactive-value="1" <?php echo iN_HelpSecure($stripeStatus) == '2' ? 'value="1" checked="checked"' : 'value="2"'; ?>>
