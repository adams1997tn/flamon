...
(2, 1, '173e98020923cd085870706acbf1a067c083b18e3807427036cc79dd172d2b82', 1776211587);
...
('watermark_opacity', '78', 1776612317),
('watermark_position', 'bottom_right', 1776612317),
('watermark_size', '19', 1776612317),
...
(1, '9313c9cd23400f5182a834c2c98ae022', 1, 1, 1776209494, 1776814294),
(2, '031f1498a86d8e99b539546a67d17b8c', 2, 1, 1776209546, 1776814346),
(3, '3d56e6b67bc6de118f13252b660434c8', 3, 1, 1776209594, 1776814394),
(4, '4a784309b4928ca4c2afd45850526318', 4, 1, 1776209992, 1776814792),
(5, 'dad4f9ec50c382fa988b22ad11181ca7', 5, 1, 1776210282, 1776815082),
(6, '674d0d411a41bf3d64fdb3a2f390a3a1', 6, 1, 1776210479, 1776815279),
(7, '943ea3c08d8b1470595ccec8dece9f1f', 7, 1, 1776210887, 1776815687),
(8, 'd3c3836e0ae331adbc982b7c2edf3338', 8, 1, 1776211194, 1776815994),
(9, 'cc7ee57f043ee8900a3c68e6a7023b47', 9, 1, 1776211342, 1776816142),
(10, '6b3b06ed6e4cb74b89dc6db367df0d73', 10, 1, 1776211638, 1776816438),
(11, 'f21f86a0f20616fada848874a66fbe7c', 11, 1, 1776211773, 1776816573),
(12, '21c3527f214e2697681ba00057cb1ecb', 12, 1, 1776212211, 1776817011),
(13, '68e0b0153b3928f4921512aa4617d531', 13, 1, 1776212358, 1776817158),
(14, 'c5ee9071a6c69e6b006fd209918ad923', 14, 1, 1776212526, 1776817326),
(15, 'a5d4f84bb8e5fd09c3b14b6bd3dd0750', 15, 1, 1776212836, 1776817636),
(16, '3111a044a8a15cfcb486d17c2ed075e0', 16, 1, 1776212985, 1776817785),
(17, '1a7827783d224d40457563491c8b932a', 17, 1, 1776215373, 1776820173);
...
(1, 1, 'uploads/avatars/2025-09-08/avatar_1757330400038179500_1.png', 1757330400, '::1');
...
(1, 1, 'uploads/covers/2025-09-08/cover_1757330382072917700_1.png', 1757330382, '::1');
...
CREATE TABLE `i_user_payments` (
  ...
  `payment_option` enum('stripe','paypal','razorpay','iyzico','authorize-net','paystack','flutterwave','bitpay','coinpayment','mercadopago','bank','moneroo','ccbill','wallet') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
--
ALTER TABLE `i_live`
  MODIFY `live_id` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `i_saved_posts`
  MODIFY `save_id` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `i_share_tokens`
  MODIFY `token_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `i_user_avatars`
  MODIFY `avatar_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `i_user_covers`
  MODIFY `cover_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `i_user_point_earnings`
  MODIFY `point_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `i_user_uploads`
  MODIFY `upload_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
